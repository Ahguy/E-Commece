    ...
    <div class="page-header min-vh-50 relative width-100 " style="background-image: url({{asset('img/shopbaner.jpg')}}">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7  ">
                    <h1 class="bds-c-hero__header"> {{$Restaurantes->name}}</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6">
    <h6> <a href="/dashboard">Home Page</a>>{{$Restaurantes->name}}</h6>
    <section class="my-5 py-5 col-lg-12">
        <div class="row ">
            <h2>Top Areas in {{$Restaurantes->name}}</h2>
        </div>
        <h2>All Shop</h2>
        <div class="row">
            <div class="col-7">
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card box-shadow mx-auto my-5" style="">
                            <img src="{{asset('img/prodimages/'. $prod->Image)}}" class="card-img-top " alt="..."
                            ...
                            <div class="card-body">
                                ...
                                <div class="cta-section">
                                    <div>{{$prod->price}}</div>
                                    <a href="{{url('add_card',$prod->id)}}" class="btn btn-light">Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="table">
                                    <div class="overflow-auto" style="h-100% d-inline-block;">
                                        <table class="table">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('img/prodimages/'.$cd->products->Image)}}"
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-3"> <a
                                                                    href="{{url('Sub_prod',$cd->products->id)}}">
                                                                    <button type="button">
                                                                        - </button>
                                                                </a></div>
                                                            <div class="col-6">
                                                                <form action="{{url('qty_input',$cd->products->id)}}"
                                                                    method="post">
                                                                    @csrf
                                                                    <input type="text"
                                                                        class="btn btn-outline-info btn-icon-text w-100"
                                                                        value="{{$cd->qty}}" name="qty_input">
                                                                </form>

                                                            </div>
                                                            <div class="col-2">
                                                                <a href="{{url('Sum_prod',$cd->products->id)}}"> <button
                                                                        type="button">
                                                                        + </button>
                                                                </a>
                                                            </div>
                                    ...
                                    <div class="total">
                                        ...
                                        <div class="total">
                                            <div class="col-12">
                                                <button type="submit"
                                                    class="btn btn-outline-success btn-icon-text w-100"
